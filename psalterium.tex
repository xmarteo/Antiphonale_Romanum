...
\canticum{Dn3b}{Cantique des trois enfants}{Dan. 3: 57-88 et 56}
...
\canticum{Quicumque}{Symbolum Athanasianum}{}

\ordinariumrubric{ORP}

\chapter{Dimanche à Tierce}

\rubric{Hymne \normaltext{Nunc Sancte nobis Spíritus}, selon les divers tons, page \pageref{ORTHa}.}
...
\rubric{Hymne \normaltext{Rector potens, verax Deus}, selon les divers tons, page \pageref{ORTHa}.}
...
\gregorioscore{F1VA1}{1}{Oracle du Seigneur à mon seigneur: siège à ma droite.}
\psalmus{109}
\gregorioscore{F1VA2}{2}{Grandes sont les oeuvres du Seigneur ; tous ceux qui les aiment s'en instruisent.}
\psalmus{110}
\gregorioscore{F1VA3}{3}{Heureux qui craint le Seigneur, qui aime entièrement sa volonté.}
\psalmus{111}
\gregorioscore{F1VA4}{4}{Béni soit le nom du Seigneur, maintenant et pour les siècles.}
\psalmus{112}
\gregorioscore{F1VA5}{5}{Notre Dieu, il est au ciel ; tout ce qu'il veut, il le fait.}
\psalmus{113}

\capitulum{2 Co. 1: 3-4}
{Benedíctus Deus, et Pater Dómini nostri Jesu \textbf{Chri}sti,\pscross{} Pater misericordiárum, et Deus totíus conso\textit{lati}`\textbf{ó}nis,\psstar{} qui consolátur nos in omni tribulatióne _\textbf{nos}tra.}
...
\canticum{1Ch29}{Cantique de David}{1 Ch. 29: 10-13}
\gscore{F2LA5}{5}{Louez le Seigneur, tous les peuples.}
\psalmus{116}

\capitulum{Rm. 13: 12-13}{Nox præcéssit, dies autem appropin\textbf{quá}vit.\pscross{} Abiciámus ergo ópera tenebrárum, et induámur \textit{arma} \textbf{lu}cis.\psstar{} Sicut in die honéste ambulémus.}{La nuit est bientôt finie, le jour est tout proche. Rejetons les œuvres des ténèbres, revêtons-nous des armes de la lumière. Conduisons-nous honnêtement, comme on le fait en plein jour.}
...
\canticum{Ben}{Cantique de Zacharie}
...
\rubric{Féries pendant l'année et fêtes simples:}
\gscore{ORPHc}{}{}
...
\canticum{Mag}{Cantique de la Bienheureuse Vierge Marie}
...
\rubric{Féries et fêtes simples:}
